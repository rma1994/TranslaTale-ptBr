...
Public Class frmMain
    ...
    Public Function drawTextLine(ByVal elem As PictureBox, ByVal text As String)
        ...
        text = text.Replace("á", "a").Replace("é", "e").Replace("í", "i").Replace("ó", "o").Replace("ú", "u").Replace("Á", "A").Replace("É", "É").Replace("Í", "I").Replace("Ó", "O").Replace("Ú", "U").Replace("ã", "a").Replace("õ", "o").Replace("ê", "e").Replace("Ã", "A").Replace("Õ", "O").Replace("Ê", "E").Replace("ç", "c").Replace("Ç", "C").Replace("à", "a").Replace("À", "A").Replace("â", "a").Replace("Â", "A")
